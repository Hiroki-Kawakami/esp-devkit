...
#   ./run.sh lilygo_t5      # LilyGo T5 ePaper S3 / ED047TC1
...
# without a rebuild/reflash. LUT rewrite is available on epd_ll targets.
...
case "$TARGET" in
  esp32s3|lilygo_t5|esp32)
    ...
    ;;
  *)
    echo "Usage: $0 [esp32s3|lilygo_t5|esp32] [idf.py args...]" >&2
    exit 1
    ;;
esac
