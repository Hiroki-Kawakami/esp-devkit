 ...
 *
 * The provider also implements read_bitmap over the presented image, which is
 * what the harness captures; synthetic input comes through bsp_harness.h.
 */
 ...
 * then comes only from bsp_harness_touch_inject(). */
