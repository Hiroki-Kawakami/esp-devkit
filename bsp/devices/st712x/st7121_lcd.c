...
static esp_err_t send_init_sequence(esp_lcd_panel_io_handle_t io,
    ...
    return mipi_dsi_send_init_cmds(io, st7121_init_cmds, st7121_init_cmds_count);
}

esp_err_t st7121_lcd_create(const st7121_config_t *config, bsp_display_t **out) {
